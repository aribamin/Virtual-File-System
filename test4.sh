...
# Compare stdout
compare_files output.log ./tests/test2/stdout_expected "stdout"

# Compare stderr
compare_files error.log ./tests/test2/stderr_expected "stderr"

# Compare disk with expected disk, ignoring carriage return characters
echo "Comparing disk with expected disk..."
cmp -b <(sed 's/\r//g' disk1) <(sed 's/\r//g' ./tests/test2/disk1_expected)
